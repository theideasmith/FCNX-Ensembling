...
hp2.DEVICE = DEVICE # Ensure hp2.DEVICE is set if used by Covariance module
...
class MyNetwork():
    ...
    def __init__(self, input_dim, num_channels,n_train,n_test,max_epochs,sigma_2,sigma_a2,sigma_w2,FL_scale,eps,seeds,activation,save_path,lr0, chi_param):
        ...
        self.activation = activation
        self.net = FCN_2_layers(self.d,self.N,1.0/(self.N*chi_param),1.0/self.d,self.activation).to(DEVICE)
