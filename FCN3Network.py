...
class FCN3Network(nn.Module):
    ...
    def model_from_hyperparameters(hyperparameters: Dict[str, float]) -> 'FCN3Network':
        ...
        activation1 = hyperparameters.get('activation1', linear_activation)
        activation2 = hyperparameters.get('activation2', linear_activation)
        ...
        model = FCN3Network(input_dim,hidden_width_1,hidden_width_2,activation1, activation2)
