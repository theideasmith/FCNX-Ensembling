...
P0 = 50  # base P
kappa0 = 0.01  # base kappa
I_list = [1, 4, 8, 16]  # sweep values for i
N0 = 200
d= 30
...
SAVEPATH = f"/home/akiva/gpnettrain/fcn3_GP_PROPORTIONALGPSCALING_{timestamp}"
# Path to the refactored net.py script
refactored_script = 'net_einsum_parallel.py'
print(f'Save to: {SAVEPATH}')
print("Starting hyperparameter sweep (EK, P/kappa constant, chi=1)...")
print("-" * 50)
