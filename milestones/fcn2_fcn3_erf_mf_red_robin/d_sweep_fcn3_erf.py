#!/usr/bin/env python3
"""
Train a single FCN3 (erf) network with MF scaling.

Usage:
    python d_sweep_fcn3_erf.py --P 1200 --d 10 --N 800 --chi 800 --kappa 0.1 --lr 1e-3 --epochs 3000000 --device cuda:0
"""
...
def train_and_track(
    ...
    print(f"\\nTraining FCN3-erf: d={d}, P={P}, N={N}, chi={chi}, kappa={kappa}, lr={lr:.3e}, ens={ens}")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a single FCN3-erf network with MF scaling")
    ...
    parser.add_argument("--to", type=str, default="results_fcn3_erf", help="Output directory name")
